...
#root.title(text) changes the window title
...
button_equal = Button(root, text="=", padx=89, pady=20, command=lambda: equal_button())
...
button_multiply = Button(root, text="x", padx=40, pady=20, command=multiply_button)
